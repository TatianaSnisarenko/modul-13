...
public class Main {
    ...
    public static final String DEFAULT_URI_FOR_USERS = "https://jsonplaceholder.typicode.com/users";
    public static final String DEFAULT_URI_FOR_POSTS = "https://jsonplaceholder.typicode.com/posts";
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        User createdUser = GSON.fromJson(HttpClientUtil.createNewUser(DEFAULT_URI_FOR_USERS, userToCreate), User.class);
        ...
        String s = HttpClientUtil.updateUser(DEFAULT_URI_FOR_USERS, DEFAULT_USER_ID_TO_OPERATE, updatedUser);
        ...
        System.out.println("Status for delete operation: " +
                HttpClientUtil.deleteUser(DEFAULT_URI_FOR_USERS, createdUser));
        ...
        List<User> allUsers = HttpClientUtil.getAllUsers(DEFAULT_URI_FOR_USERS);
        ...
        System.out.println("userGottenByIdOne = " + HttpClientUtil.getUserById(DEFAULT_URI_FOR_USERS, DEFAULT_USER_ID_TO_OPERATE));
        ...
        System.out.println("userGottenByName = " + HttpClientUtil.getUserByName(DEFAULT_URI_FOR_USERS, DEFAULT_USER_NAME));
        ...
        /*
        List<Comment> allCommentsForLastPostOfUser = ;
        allCommentsForLastPostOfUser.forEach(System.out::println);

        GSON.fromJson(responseComments.body(), new TypeToken<List<Comment>>(){}.getType());

        */

        System.out.println("Testing task 2: getting all comments for last Post of User with id = 1: ");
        System.out.println();
        System.out.println(HttpClientUtil.getAllCommentsForLastPostOfUser(DEFAULT_URI_FOR_USERS, DEFAULT_URI_FOR_POSTS, createdUser));
        ...
        List<Task> allOpenTasks = HttpClientUtil.getListOfOpenTasksForUser(DEFAULT_URI_FOR_USERS, createdUser);
